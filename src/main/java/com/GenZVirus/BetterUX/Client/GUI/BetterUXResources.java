...
public class BetterUXResources {
	...
	public static String EXP_BAR_OVERLAY = "exp_bar_overlay.png";
	public static String HEALTH_BAR_FILL = "health_bar_fill.png";
	public static String HEALTH_BAR_OVERLAY = "health_bar_overlay.png";
	...
	public static String FOOD_BAR_OVERLAY = "food_bar_overlay.png";
	...
	public static String WATER_BREATING_BAR_OVERLAY = "water_breathing_bar_overlay.png";
